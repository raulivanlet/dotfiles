...
if [ ! -d /home/${USER}/data/homepage ]; then sudo mkdir ${DATA}/data/homepage; fi
if [ ! -d /home/${USER}/data/homepage/config ]; then sudo mkdir ${DATA}/data/homepage/config; fi
if [ ! -d /home/${USER}/data/homepage/icons ]; then sudo mkdir ${DATA}/data/homepage/icons; fi

#--------------------Update homepage files
if [ -f /home/${USER}/data/homepage/config/bookmarks.yaml ];
    then sudo bash -c 'cat configs/homepage/bookmarks.yaml > ${DATA}/data/homepage/config/bookmarks.yaml';
...
if [ -f /home/${USER}/data/homepage/config/docker.yaml ];
    then sudo bash -c 'cat configs/homepage/docker.yaml > ${DATA}/data/homepage/config/docker.yaml';
...
if [ -f /home/${USER}/data/homepage/config/services.yaml ];
    then sudo bash -c 'cat configs/homepage/services.yaml > ${DATA}/data/homepage/config/services.yaml';
...
if [ -f /home/${USER}/data/homepage/config/settings.yaml ];
    then sudo bash -c 'cat configs/homepage/settings.yaml > ${DATA}/data/homepage/config/settings.yaml';
...
if [ -f /home/${USER}/data/homepage/config/widgets.yaml ];
    then sudo bash -c 'cat configs/homepage/widgets.yaml > ${DATA}/data/homepage/config/widgets.yaml';
