...
if [ -f  ${DATA}/data/zigbee2mqtt/zigbee/config.yaml ];
    then sudo bash -c 'cat configs/server/zigbeeconfig.yaml > ${DATA}/data/zigbee2mqtt/zigbee/config.yaml';
...
if [ -f  ${DATA}/data/zigbee2mqtt/mosquitto/mosquitto.conf ];
    then sudo bash -c 'cat configs/server/mosquitto.conf > ${DATA}/data/zigbee2mqtt/mosquitto/mosquitto.conf';
